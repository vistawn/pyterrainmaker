...
class TileScheme(object):
    ...
    __tile_source_bands = {}
    # data extent
    __minx = __maxy = __maxx = __miny = None

    no_data = 0
    repalce_no_data = None
    ...
    def generate_scheme(self, is_compact):
        ...
        for level in sorted(self.__levels.keys(), reverse=True):
            ...
            has_child = True
        # self.generate_bundles_by_level(1, True)
